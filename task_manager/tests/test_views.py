...
class TestTaskAPI:
    ...
    def test_create_task(self, api_client):
        ...
        response = api_client.post(reverse('task_manager:task-create'), data=data, format='json')
    ...
    def test_get_task_detail(self, api_client, tasks, pk_task):
        ...
        response = api_client.get(reverse('task_manager:task-detail', args=(pk_task,)), format='json')
        assert response.status_code == 200
    ...
    def test_update_task(self, api_client, tasks, pk_task):
        ...
        response = api_client.put(reverse('task_manager:task-update', args=(pk_task,)), data=data, format='json')
        assert response.status_code == 200
    ...
    def test_delete_task(self, api_client, tasks, pk_task):
        ...
        '''
        response = api_client.delete(reverse('task_manager:task-delete', args=(pk_task,)))
